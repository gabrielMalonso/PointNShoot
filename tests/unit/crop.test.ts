...
describe("computeCropPlan", () => {
  it("derives scale from screenshot dimensions instead of DPR", () => {
    const crop = computeCropPlan({ x: 100, y: 80, width: 200, height: 120 }, viewport, { width: 1500, height: 1200 }, 50);
  ...
  it("clamps crops near viewport edges", () => {
    const crop = computeCropPlan({ x: -20, y: 760, width: 120, height: 100 }, viewport, { width: 2000, height: 1600 }, 48);
